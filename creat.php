...
class TableClassGenerator
{
	...
	private function generateMultiRetrive($columns, $class, $primary_key) 
	{
		...
		$this->writeNewLine();
		$this->writeToFile("\$obj->before_writeback();", 3);
		$this->writeToFile("\$objs[\$this->objkey.'_'.\$obj->$primary_key] = \$obj;", 3);
		$this->writeToFile("}", 2);
		$this->writeToFile("\$records->free();", 2);
		$this->writeToFile("unset(\$records);", 2);
...
'key_pre' => 'game_txc',
'multi_arr' => array('agent_buy'=>'buy_aid','agent_info'=>'aid','income'=>'out_trade_no','user'=>'uid','play_recharge'=>'play_rid'
),
));
